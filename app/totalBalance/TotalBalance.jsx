    ...
    <div className="goals rounded shadow-lg pt-2 pb-1 px-1">
      <div className="row g-1 ">
        ...
        <div className="col-md-5 ">
          <h5 className="sums fw-normal">₦{sumBalance}</h5>
          <h4 className="perr justify-content-center align-items-center">
            <span className="px-1">
              <svg
          ...
          <h4 className="perr">+₦{perAmount}</h4>
        </div>
      </div>
    </div>
  );
